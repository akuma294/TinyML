...
#define AI_NETWORK_MODEL_SIGNATURE     "e10eab350c5025441df903c2880efdb8"
...
#define AI_TOOLS_DATE_TIME   "Wed Oct 11 19:07:00 2023"
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(serving_default_input_20_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.015354356728494167f),
    AI_PACK_INTQ_ZP(-1)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_1_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0223896075040102f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_3_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.06313382089138031f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_4_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.007612425833940506f),
    AI_PACK_INTQ_ZP(-73)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_1_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.003470559371635318f, 0.00384338665753603f, 0.0031432947143912315f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_3_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.010225887410342693f),
    AI_PACK_INTQ_ZP(0)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 892, 1, 1), AI_STRIDE_INIT(4, 1, 1, 892, 892),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x1,
  AI_SHAPE_INIT(4, 1, 1, 1, 1250), AI_STRIDE_INIT(4, 1, 1, 1, 1),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x1,
  AI_SHAPE_INIT(4, 1, 1, 1250, 1), AI_STRIDE_INIT(4, 1, 1, 1, 1250),
  1, &serving_default_input_20_output_array, &serving_default_input_20_output_array_intq)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x1,
  AI_SHAPE_INIT(4, 1, 3, 37, 1), AI_STRIDE_INIT(4, 1, 1, 3, 111),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  7, 0x1,
  AI_SHAPE_INIT(4, 1, 111, 1, 1), AI_STRIDE_INIT(4, 1, 1, 111, 111),
  1, &conv2d_1_output_array, &conv2d_1_output_array_intq)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 111, 1, 1), AI_STRIDE_INIT(4, 2, 2, 222, 222),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x1,
  AI_SHAPE_INIT(4, 1, 85, 1, 3), AI_STRIDE_INIT(4, 1, 1, 3, 255),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 10, 1, 1), AI_STRIDE_INIT(4, 2, 2, 20, 20),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x1,
  AI_SHAPE_INIT(4, 111, 10, 1, 1), AI_STRIDE_INIT(4, 1, 111, 1110, 1110),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1436, 1, 1),
    1436, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
